    ...
    <div className="Edit">
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          required
        />
        <label htmlFor="fiber" className="edit_labels">
          Fiber:
        </label>
        <input
          id="fiber"
          ...
          onChange={handleText}
        />
        <label htmlFor="protein" className="edit_labels">
          Protein:
        </label>
        <input
          id="protein"
          ...
          onChange={handleText}
        />
        <label htmlFor="added_sugar" className="edit_labels">
          Added Sugar:
        </label>
        <input
          id="added_sugar"
        ...
        />
        <label htmlFor="image" className="edit_labels">
          Photo:
        </label>
        <input
          id="image"
